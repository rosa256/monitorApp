...
public class LoginActivity extends AppCompatActivity {
    ...
    private int FORGOT_PASSWORD_REQUEST = 10;
    ...
    ForgotPasswordHandler forgotPasswordHandler = new ForgotPasswordHandler() {
        ...
        public void onSuccess() {
            new MaterialDialog.Builder(LoginActivity.this).title("Success")
        ...
        public void onFailure(Exception e) {
            new MaterialDialog.Builder(LoginActivity.this).title("Failed")
                    .content(R.string.user_not_found)
                    .theme(Theme.LIGHT)
                    .positiveColor(Color.GRAY)
                    .positiveText("ok")
                    .show();
    ...
    AuthenticationHandler authenticationHandler = new AuthenticationHandler() {
        ...
        public void onFailure(Exception e) {
            ...
            if(e.getClass().equals(UserNotConfirmedException.class)){
                ...
                new MaterialDialog.Builder(LoginActivity.this).title("Sign-in failed")
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                AppHelper.getPool().getUser(username).resendConfirmationCode(verificationHandler);
                            }
                        })
                        .show();
                ...
                new MaterialDialog.Builder(LoginActivity.this).title(R.string.wrong_credentials)
    ...
    VerificationHandler verificationHandler = new VerificationHandler() {
        ...
        public void onSuccess(CognitoUserCodeDeliveryDetails verificationCodeDeliveryMedium) {
            Intent confirmIntent = new Intent(LoginActivity.this, RegisterConfirmation.class);
            startActivity(confirmIntent);
        }

        @Override
        public void onFailure(Exception exception) {
            new MaterialDialog.Builder(LoginActivity.this).title("Resend code failed")
                    .content("Resend code is not possible. Try again later.")
                    .theme(Theme.LIGHT)
                    .positiveColor(Color.GRAY)
                    .positiveText("Ok")
                    .show();
    ...
    private void getForgotPasswordCode(ForgotPasswordContinuation forgotPasswordContinuation) {
        ...
        intent.putExtra("deliveryMedium", forgotPasswordContinuation.getParameters().getDeliveryMedium());
        startActivityForResult(intent, FORGOT_PASSWORD_REQUEST);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == FORGOT_PASSWORD_REQUEST) {
