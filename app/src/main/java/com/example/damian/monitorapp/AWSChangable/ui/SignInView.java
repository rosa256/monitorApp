...
public class SignInView extends LinearLayout {
    ...
    private static final int MAX_IMAGE_HEIGHT = dp(150);

    /** Margins of the logo image. */
    private static final int IMAGE_MARGINS = dp(30);

    /** Margins for the Image Layout that holds the logo image. */
    private static final int IMAGE_LAYOUT_MARGINS = dp(20);

    /** String that represents the SDK Version. */
    private static final String SDK_VERSION = "2.6.11";
    ...
    private void setUpSignInButtons(final Context context) {
        ...
        signInButtonHeight = getResources().getDimensionPixelSize(R.dimen.sign_in_custom_button_height);
